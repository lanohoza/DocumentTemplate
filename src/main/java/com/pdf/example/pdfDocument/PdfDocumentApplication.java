...
public class PdfDocumentApplication {
	private static List<Product> showProductList(){
		return Arrays.asList(
				...
				new Product("4","hp","pc","image.png","laptop",565,"pcs",5,"ETEY67"),
				new Product("5","hp","pc","image.png","laptop",565,"pcs",5,"ETEY67"),
				new Product("6","hp","pc","image.png","laptop",565,"pcs",5,"ETEY67")
		);
	}
	...
	public static void main(String[] args) throws DocumentException, FileNotFoundException {
		...
		Buyer bayer=new Buyer("1","Lachraf","NourElhouda","","06789536","Cité 300","442","556","75646");
		Facture facture=new Facture("2","23","13/5/2021","4/5/2021");
